...
contract CryptoSafetyTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CryptoSafetyToken contract."
        );
    }
...
contract CryptoSafetyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CryptoSafetyTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = CryptoSafetyTokenDividendTracker(
